...
export default class BetTable extends React.Component {
  render() {
    return (
      <Table fluid="md" className="mt3 gray-color" style={{ borderColor: 'black' }} onClick={this.props.onClick} bordered id={this.props.elem.id}>
        <thead>
        ...
        <tbody>
          <tr className='td-no-wrap td-quarter'>
            <td rowSpan="2" className="align-middle text-center">{this.props.elem.startTime.toLocaleDateString()}<br />{this.props.elem.startTime.toLocaleTimeString()}</td>
            <td>
            ...
            <td className="cursor-pointer spread away">{this.props.elem.spreads[0].point > 0 ? '+' : ''}{this.props.elem.spreads[0].point} ({this.props.elem.spreads[0].price})</td>
          ...
          <tr className='td-no-wrap td-quarter'>
            ...
            <td className="cursor-pointer spread home">{this.props.elem.spreads[1].point > 0 ? '+' : ''}{this.props.elem.spreads[1].point} ({this.props.elem.spreads[1].price})</td>
