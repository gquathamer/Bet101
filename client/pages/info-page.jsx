...
export default class InfoPage extends React.Component {
  render() {
    return (
      <Container className="info-container" fluid="md">
        <Row className="justify-content-center">
          <Col className="column-border" xs={12} md={9} >
            <Row>
            ...
            <Row>
              ...
              <Row className="justify-content-center">
                <Col xs={12} md={9} className="text-center my-3">
                  <img src={oddsImage} />
                </Col>
              </Row>
              <p>
            ...
            <Row>
              ...
              <Row className="justify-content-center">
                <Col className="text-center my-3" xs={12} md={4}>
                  <img src={moneyline} />
                </Col>
              </Row>
              <br />
            ...
            <Row>
              ...
              <Row className="justify-content-center">
                <Col md={9} xs={12} className="text-center my-3">
                  <img src={oddsImage} />
                </Col>
              </Row>
              <p>
